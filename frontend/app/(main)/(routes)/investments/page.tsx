  ...
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] px-6 text-center space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground font-medium max-w-[250px] mx-auto text-sm leading-relaxed">Track your stocks, mutual funds, and assets in one place. coming soon.</p>
      </div>
    </div>
  )
}
