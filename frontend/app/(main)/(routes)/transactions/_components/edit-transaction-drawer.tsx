      ...
      <DrawerContent className="max-h-[95vh] bg-[#F8F8F8] dark:bg-zinc-950">
        <DrawerHeader className="relative flex items-center justify-center border-b border-border/50 pb-4 bg-white dark:bg-zinc-900 rounded-t-[inherit]">
          ...
          <button 
            ...
            disabled={isDeleting}
            className="absolute right-6 p-2 text-rose-500 hover:bg-rose-50 rounded-full transition-colors disabled:opacity-50"
          >
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-border/40 overflow-hidden">
              <div className="p-4 border-b border-border/40">
                ...
                <p className="text-sm font-bold text-foreground">
                  {format(new Date(transaction.originalDate), "dd MMM yyyy 'at' h:mm a")}
                </p>
              </div>
              <div className="p-4 space-y-3">
                ...
                <div className="flex gap-4">
                  <div className="flex flex-col gap-3 flex-1">
                    <Label htmlFor="date-picker" className="px-1 text-[10px] font-black text-muted-foreground/40 uppercase">Date</Label>
                    <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          id="date-picker"
                          className="w-full justify-between font-bold bg-secondary/30 border-none rounded-xl h-11 px-4"
                        >
                  ...
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="time-picker" className="px-1 text-[10px] font-black text-muted-foreground/40 uppercase">Time</Label>
                    <Input
                      type="time"
                      id="time-picker"
                      step="1"
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-border/40 overflow-hidden">
              <div className="p-4 border-b border-border/40">
                ...
                <p className="text-sm font-bold text-foreground">
                  {transaction.originalAmount?.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                </p>
              </div>
              <div className="p-4 space-y-2">
